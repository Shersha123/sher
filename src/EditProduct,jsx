...
const navigate = useNavigate()
   const formik = useFormik({
        ...
        onSubmit: async (values) => {
         await axios.put(`https://63770e2081a568fc250af1f6.mockapi.io/product/${params.id}`, values)
    ...
    let loadUser = async () => {
        try{
            let product = await axios.get(`https://63770e2081a568fc250af1f6.mockapi.io/product/${params.id}`)
        formik.setValues({
