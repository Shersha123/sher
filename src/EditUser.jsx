...
function EditUser() {
  ...
  const navigate  = useNavigate()
    ...
    return errors;
       ...
       await axios.put(`https://63770e2081a568fc250af1f6.mockapi.io/users/${params.id}`, values)
...
let loadUser = async () => {
  try{
    let user = await axios.get(`https://63770e2081a568fc250af1f6.mockapi.io/users/${params.id}`);
    formik.setValues({
         name: user.data.name ,
